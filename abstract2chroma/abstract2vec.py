...
with open(f"data/studies/studies_{args.year}.csv", encoding="utf-8") as input_csv, \
    open(f"data/embeddings/embeddings_{args.year}.csv", "w", encoding="utf-8") as output_csv:
